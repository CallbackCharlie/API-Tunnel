    ...
    return (
        ...
        <div
            className="sm:hidden flex flex-1
                justify-end items-center curor-pointer">
            <img
            ...
            <div
                ...
                right-0 my-2 min-w-[140px] rounded-x1 sidebar border-rounded m-[25px]`}
                >
                    <ul className="list-none flex justify-end
                    items-start flex-1 flex-col">
                        {navLinks.map((nav, index) => (
                            <li
                                key={nav.id}
                                className={`font-poppins
                                font-medium cursor-pointer
                                text-[16px] text-white opacity-100
